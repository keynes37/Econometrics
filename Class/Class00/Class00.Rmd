...
- Poseer un usuario y cuenta en [Discord](https://discord.com) e inscribirse en el siguiente [https://discord.gg/rQrrVJcS](https://discord.gg/rQrrVJcS)
...
4. Usar Google Colab. [Google Colaboratory](https://colab.research.google.com/)

---
# A tener en cuenta
| **Responsabilidad**                     | **Tipo de trabajo**         | **Fecha estimada**             | **Ponderación** |
|----------------------------------------|-----------------------------|--------------------------------|-----------------|
| **Evaluaciones Parciales**             | Exámenes                    | Semana 5 y 9                   | 40% (20% c/u)   |
| **Actividades**                        | Individual y grupal         | A lo largo del semestre        | 30%             |
| **Examen Final**                       | Examen                      | Según calendario académico     | **30%**         |
| **Total**                              |                             |                                | **100%**        |
