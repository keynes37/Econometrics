...
Observe que la probabilidad de caer en la **zona de no rechazo** es tan solo de un 2.7%, -demasiado pequeña-. Necesitamos que $JB<\chi_{Critico}$. Para el caso, el estadístico nos da $JB=7.2082>3.84$
...
scale_y_continuous(breaks = c(lm0$coefficients[2]),labels = c(TeX("$\\beta_1$"))) +
